...
def routerNet():
    ...
    h0 = net.addHost( 'h0' , ip='192.168.1.2/24', defaultRoute = 'via 192.168.1.1')
    h1 = net.addHost( 'h1' , ip='192.168.3.2/24', defaultRoute = 'via 192.168.3.1')
    h2 = net.addHost( 'h2' , ip='192.168.4.2/24', defaultRoute = 'via 192.168.4.1')
    h3 = net.addHost( 'h3' , ip='192.168.5.2/24', defaultRoute = 'via 192.168.5.1')
    ...
    net[ 'r0' ].cmdPrint( 'tc qdisc add dev r0-eth0 parent 1: classid 1:1 cbq rate 5Mbit avpkt 1000 bounded')
    net[ 'r0' ].cmdPrint( 'tc qdisc add dev r0-eth0 parent 1: classid 1:2 cbq rate 5Mbit avpkt 1000 isolated')
