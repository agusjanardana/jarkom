...
class NetworkTopo(Topo):
	def build(self,**_opts):
		...
		#r2 = self.addNode('r2', cls=LinuxRouter, ip='192.168.0.9/30')
		...
		self.addLink(hA,r1, intfName1='hA-eth0', intfName2='r1-eth0', params1={'bw': 1, 'ip' : '192.168.0.2/30' }, params2={'bw': 1, 'ip' : '192.168.0.1/30' })
		self.addLink(hA,r2, intfName1='hA-eth1', intfName2='r2-eth0', params1={'bw': 1, 'ip' : '192.168.0.6/30' }, params2={'bw': 1, 'ip' : '192.168.0.5/30' })
